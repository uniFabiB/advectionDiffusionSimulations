...
outfile_theta.write(project(theta, V_out, name="theta"),project(theta, V_out, name="theta again"),project(gradThetaX, V_out, name="d/dx theta"),project(gradThetaY, V_out, name="d/dy theta"), project(l_batFunction, V_out, name="l_bat"),  time=t)
