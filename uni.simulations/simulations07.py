...
print("dominant wavelength (from laplace laplace^2) l_dom=",str(l_dom))
...
outfile_theta.write(project(theta, V_out, name="theta"),project(theta, V_out, name="theta again"),project(gradThetaX, V_out, name="d/dx theta"),project(gradThetaY, V_out, name="d/dy theta"), project(l_batFunction, V_out, name="l_bat"), project(l_domFunction, V_out, name="l_dom"), time=t)
